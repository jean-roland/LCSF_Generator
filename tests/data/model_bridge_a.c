...
static void LCSF_Bridge_TestCC2GetData(lcsf_valid_att_t *pAttArray, test_cmd_payload_t *pCmdPayload) {
    ...
    pCmdPayload->cc2_payload.sa5Size = pAttArray[TEST_CC2_ATT_SA5].PayloadSize;
    ...
    if (pAttArray[TEST_CC2_ATT_SA9].Payload.pData != NULL) {
        ...
        pCmdPayload->cc2_payload.sa9Size = pAttArray[TEST_CC2_ATT_SA9].PayloadSize;
    }
...
static bool LCSF_Bridge_TestCC1FillAtt(lcsf_valid_att_t **pAttArrayAddr, test_cmd_payload_t *pCmdPayload) {
    ...
    if (!LifoGet(&LcsfBridgeTestInfo.Lifo, LCSF_TEST_CMD_CC1_ATT_NB, (void *)pAttArrayAddr)) {
        return false;
    }
    ...
    pAttArray[TEST_CC1_ATT_SA5].PayloadSize = pCmdPayload->cc1_payload.sa5Size;
    ...
    if ((pCmdPayload->cc1_payload.optAttFlagsBitfield & TEST_CC1_ATT_SA10_FLAG) != 0) {
        pAttArray[TEST_CC1_ATT_SA10].PayloadSize = pCmdPayload->cc1_payload.sa10Size;
...
static bool LCSF_Bridge_TestCC4FillAtt(lcsf_valid_att_t **pAttArrayAddr, test_cmd_payload_t *pCmdPayload) {
    ...
    // Allocate attribute array
    if (!LifoGet(&LcsfBridgeTestInfo.Lifo, LCSF_TEST_CMD_CC4_ATT_NB, (void *)pAttArrayAddr)) {
        return false;
    }
    // Intermediary variable
    lcsf_valid_att_t *pAttArray = *pAttArrayAddr;
    ...
    if (!LifoGet(&LcsfBridgeTestInfo.Lifo, LCSF_TEST_ATT_CA1_SUBATT_NB, (void *)pSubAttArray)) {
        return false;
    }
    ...
    if ((pCmdPayload->cc4_payload.optAttFlagsBitfield & TEST_CC4_ATT_CA2_FLAG) != 0) {
        ...
        // Allocate sub-attribute array
        if (!LifoGet(&LcsfBridgeTestInfo.Lifo, LCSF_TEST_ATT_CA2_SUBATT_NB, (void *)pSubAttArray)) {
            return false;
        }
        // Fill data of sub-attribute SA1
        ...
        // Allocate sub-attribute array
        if (!LifoGet(&LcsfBridgeTestInfo.Lifo, LCSF_TEST_ATT_CA3_SUBATT_NB, (void *)pSubAttArray)) {
            return false;
        }
            // Fill data of sub-attribute SA1
            ...
            // Allocate sub-attribute array
            if (!LifoGet(&LcsfBridgeTestInfo.Lifo, LCSF_TEST_ATT_CA4_SUBATT_NB, (void *)pSubAttArray)) {
                return false;
            }
