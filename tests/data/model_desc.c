...
static const lcsf_attribute_desc_t LCSF_Test_CA12_AttDescArray[LCSF_TEST_ATT_CA12_SUBATT_NB] = {
    {false, LCSF_BYTE_ARRAY, LCSF_TEST_CA12_ATT_ID_SA4, 0, NULL},
};

// Sub-attribute array descriptor of attribute CA11
static const lcsf_attribute_desc_t LCSF_Test_CA11_AttDescArray[LCSF_TEST_ATT_CA11_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CA10_AttDescArray[LCSF_TEST_ATT_CA10_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CA9_AttDescArray[LCSF_TEST_ATT_CA9_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CA8_AttDescArray[LCSF_TEST_ATT_CA8_SUBATT_NB] = {
    {false, LCSF_BYTE_ARRAY, LCSF_TEST_CA8_ATT_ID_SA4, 0, NULL},
};

// Sub-attribute array descriptor of attribute CA7
static const lcsf_attribute_desc_t LCSF_Test_CA7_AttDescArray[LCSF_TEST_ATT_CA7_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CA6_AttDescArray[LCSF_TEST_ATT_CA6_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CA5_AttDescArray[LCSF_TEST_ATT_CA5_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CA4_AttDescArray[LCSF_TEST_ATT_CA4_SUBATT_NB] = {
    {false, LCSF_BYTE_ARRAY, LCSF_TEST_CA4_ATT_ID_SA4, 0, NULL},
};

// Sub-attribute array descriptor of attribute CA3
static const lcsf_attribute_desc_t LCSF_Test_CA3_AttDescArray[LCSF_TEST_ATT_CA3_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CA2_AttDescArray[LCSF_TEST_ATT_CA2_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CA1_AttDescArray[LCSF_TEST_ATT_CA1_SUBATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CC1_AttDescArray[LCSF_TEST_CMD_CC1_ATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CC2_AttDescArray[LCSF_TEST_CMD_CC2_ATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CC3_AttDescArray[LCSF_TEST_CMD_CC3_ATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CC4_AttDescArray[LCSF_TEST_CMD_CC4_ATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CC5_AttDescArray[LCSF_TEST_CMD_CC5_ATT_NB] = {
...
static const lcsf_attribute_desc_t LCSF_Test_CC6_AttDescArray[LCSF_TEST_CMD_CC6_ATT_NB] = {
...
static const lcsf_command_desc_t LCSF_Test_CmdDescArray[LCSF_TEST_CMD_NB] = {
...
const lcsf_validator_protocol_desc_t LCSF_Test_ProtDesc = {.ProtId = LCSF_TEST_PROTOCOL_ID, .ProtVer = LCSF_TEST_PROTOCOL_VERSION, .pProtDesc = &LCSF_Test_Desc, .pFnInterpretMsg = LCSF_Bridge_TestReceive};
