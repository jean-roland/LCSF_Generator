...
// Model command
Command cmd0("SC1", 0, false, NS_DirectionType::UNKNOWN, "");
Command cmd1("SC2", 1, false, NS_DirectionType::UNKNOWN, "");
Command cmd2("SC3", 2, false, NS_DirectionType::UNKNOWN, "");
Command cmd3("CC1", 3, false, NS_DirectionType::UNKNOWN, "");
Command cmd4("CC2", 4, false, NS_DirectionType::UNKNOWN, "");
Command cmd5("CC3", 5, false, NS_DirectionType::UNKNOWN, "");
Command cmd6("CC4", 6, false, NS_DirectionType::UNKNOWN, "");
Command cmd7("CC5", 7, false, NS_DirectionType::UNKNOWN, "");
Command cmd8("CC6", 8, false, NS_DirectionType::UNKNOWN, "");
const QList<Command *> cmd_list = {&cmd0, &cmd1, &cmd2, &cmd3, &cmd4, &cmd5, &cmd6, &cmd7, &cmd8};
...
const QString unk_def = R"(// --- Private Types ---
...
const QString def_cmd_hdl = "            return false;\n";

const QString fct_sc2 = R"(/**
...
const QString fct_sc3 = R"(static bool TestExecuteSC3(void) {
    return TestSendCommand(TEST_CMD_SC3, false);
}

)";

const QString fct_cc2 = R"(static bool TestExecuteCC2(test_cmd_payload_t *pCmdPayload) {
    if (pCmdPayload == NULL) {
       return false;
    }
    // Declare attributes
...
const QString fct_cc3 = R"(static bool TestExecuteCC3(test_cmd_payload_t *pCmdPayload) {
    if (pCmdPayload == NULL) {
       return false;
    }
    // Declare attributes
...
const QString fct_cc5 = R"(static bool TestExecuteCC5(test_cmd_payload_t *pCmdPayload) {
    if (pCmdPayload == NULL) {
       return false;
    }
    // Declare attributes
...
const QString fct_cc6 = R"(static bool TestExecuteCC6(test_cmd_payload_t *pCmdPayload) {
    if (pCmdPayload == NULL) {
       return false;
    }
    // Declare attributes
...
const QStringList cmd_fct = {"", fct_sc2, fct_sc3, "", fct_cc2, fct_cc3, "", fct_cc5, fct_cc6};