...
private slots:
    void on_actionNew_protocol_triggered();
    void on_actionSave_protocol_triggered();
    void on_actionLoad_protocol_triggered();
    void on_actionDocumentation_triggered();
    void on_actionAbout_triggered();
    void on_twDescTreeView_currentItemChanged(QTreeWidgetItem *current, QTreeWidgetItem *previous);
    void on_pbSaveTable_clicked();
    void on_pbAddTableLine_clicked();
    void on_pbDeleteTableLine_clicked();
    void on_pbRefreshTable_clicked();
    void on_pbSortTable_clicked();
    void on_pbGenerateDesc_clicked();
    void on_pbImportDescA_clicked();
    void on_pbImportDescB_clicked();
    void on_pbGenerateDoc_clicked();
